...
public class UpdateUserInput {
  ...
  public String toString() {
    return "{" + "email:" + (email != null?"\"":"") + email + (email != null?"\"":"") + "," +"username:" + (username != null?"\"":"") + username + (username != null?"\"":"") + "," +"password:" + (password != null?"\"":"") + password + (password != null?"\"":"") + "," +"image:" + (image != null?"\"":"") + image + (image != null?"\"":"") + "," +"bio:" + (bio != null?"\"":"") + bio + (bio != null?"\"":"") + "" +"}";
  }
